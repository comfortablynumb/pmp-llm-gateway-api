...
-- Enable persistence (execution logging) for development
INSERT INTO app_configurations (key, data) VALUES
('app_config', '{
    "id": "app_config",
    "entries": {
        "persistence.enabled": {
        ...
        "persistence.log_retention_days": {
            "key": "persistence.log_retention_days",
            "value": {"Integer": 30},
            "category": "Persistence",
        ...
        "persistence.log_sensitive_data": {
            "key": "persistence.log_sensitive_data",
            "value": {"Boolean": true},
            "category": "Persistence",
            "description": "Log sensitive data (prompts, responses)",
            "updated_at": "2026-01-05T00:00:00Z"
        },
        "persistence.enabled_models": {
            "key": "persistence.enabled_models",
            "value": {"StringList": []},
            "category": "Persistence",
            "description": "List of model IDs to log executions for (empty = all if enabled)",
            "updated_at": "2026-01-05T00:00:00Z"
        },
        "persistence.enabled_workflows": {
            "key": "persistence.enabled_workflows",
            "value": {"StringList": []},
            "category": "Persistence",
            "description": "List of workflow IDs to log executions for (empty = all if enabled)",
            "updated_at": "2026-01-05T00:00:00Z"
        }
    }
}')
